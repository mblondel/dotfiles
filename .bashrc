...
if [ -e $projectroot/taskmanager ] ; then
    export PYTHONPATH=$projectroot/taskmanager:$PYTHONPATH
fi

if [ -e $projectroot/tlml ] ; then
    export PYTHONPATH=$projectroot/tlml:$PYTHONPATH
fi

if [ -e $projectroot/plsa ] ; then
    export PYTHONPATH=$projectroot/plsa:$PYTHONPATH
fi

if [ -e $projectroot/medline ] ; then
    export PYTHONPATH=$projectroot/medline:$PYTHONPATH
fi
